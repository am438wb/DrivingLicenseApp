        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenceCategory = table.Column<string>(type: "text", nullable: false),
                    PhotoPath = table.Column<string>(type: "text", nullable: false),
                    PhotoContentType = table.Column<string>(type: "text", nullable: false),
                    PhotoSize = table.Column<long>(type: "bigint", nullable: false),
                    PhotoQualityScore = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_workflow_history_applications_ApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_workflow_history_ApplicationId_Timestamp",
